...
<div>
    <form id="form1" name="form1" action="" method="post" onsubmit="return notnull(this);">
        ...
        <br>';
        if ($_SERVER['language']=='zh-cn') $html .= '你要理解 https://redirectonedrive.github.io/ 是github上的静态网站，<br><font color="red">除非github真的挂掉</font>了，<br>不然，稍后你如果<font color="red">连不上</font>，请检查你的运营商或其它“你懂的”问题！<br>';
        $html .='
        <input type="submit" value="' . getconstStr('Submit') . '">
    </form>
</div>
